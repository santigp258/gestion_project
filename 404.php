...
<head>
  ...
  <link rel="stylesheet" href="<?php echo BASE_URL?>/404/bootstrap.css">
  <link rel="stylesheet" href="<?php echo BASE_URL?>/404/404.scss">
</head>
<body>
<main>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        <h1>404</h1>
        <h2>Opps... Te equivocaste de dirección.</h2>
        <p>La pagína que buscas no existe. A veces nos perdemos en el umbral del infinito; espero que no sea tu caso.
          Mejor presiona el siguiente botón y encuentra nuevamente tu ruta. ¡Buena suerte!
        </p>
        <button class="btn green" ><a href="<?php echo BASE_URL ?>index.php">Regresar</a></button>
      </div>
    </div>
  </div>
</main>
<script src="<?php echo BASE_URL ?>404/gsap.js"></script>
<script src="<?php echo BASE_URL ?>404/404.js"></script>
</body>
</html>